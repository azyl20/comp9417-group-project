...
labels = ['stack_train', 'forest_train',
          'boost_train', 'svm_train', 'knn_train']

i = 0
for data in [stack_train, forest_train, boost_train, svm_train, knn_train]:
...
labels = ['stack_test', 'forest_test',
          'boost_test', 'svm_test', 'knn_test']
i = 0
for data in [stack_test, forest_test, boost_test, svm_test, knn_test]:
    plt.scatter(list(range(200)), data, label=labels[i], marker='.')
    i += 1
